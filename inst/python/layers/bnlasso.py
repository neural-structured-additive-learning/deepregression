...
class SparseBatchNormalizationBase(Layer):
    ...
    *after having been trained on data that has similar statistics as the
    ...
    def __init__(
        ...
        gamma1_initializer="ones",
        gamma2_initializer=tf.keras.initializers.HeNormal,
        gamma_sparsity=None,
        ...
        **kwargs,
        ...
        self.gamma1_initializer = initializers.get(gamma1_initializer)
        self.gamma2_initializer = initializers.get(gamma2_initializer)
        ...
        self.gamma1_regularizer = regularizers.get(tf.keras.regularizers.l2(self.gamma_sparsity))
        self.gamma2_regularizer = regularizers.get(tf.keras.regularizers.l2(self.gamma_sparsity))
        self.beta_constraint = constraints.get(beta_constraint)
        self.gamma1_constraint = constraints.get(gamma1_constraint)
        self.gamma2_constraint = constraints.get(gamma2_constraint)
        self.renorm = renorm
    ...
    def build(self, input_shape):
        ...
        if self.scale:
            self.gamma1 = self.add_weight(
                ...
                initializer=self.gamma1_initializer,
            ...
            self.gamma2 = self.add_weight(
                ...
                shape=param_shape,
                dtype=self._param_dtype,
                initializer=self.gamma2_initializer,
...
# DR: HERE CHANGE COMPUTATION
    ...
    def get_config(self):
        config = {
            ...
            "gamma1_initializer": initializers.serialize(self.gamma1_initializer),
            "gamma2_initializer": initializers.serialize(self.gamma2_initializer),
            ...
            "gamma1_regularizer": regularizers.serialize(self.gamma1_regularizer),
            "gamma2_regularizer": regularizers.serialize(self.gamma2_regularizer),
            "beta_constraint": constraints.serialize(self.beta_constraint),
            "gamma1_constraint": constraints.serialize(self.gamma1_constraint),
            "gamma2_constraint": constraints.serialize(self.gamma2_constraint),
        }
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            ...
            gamma1_initializer=gamma1_initializer,
            gamma2_initializer=gamma2_initializer,
            moving_mean_initializer=moving_mean_initializer,
            moving_variance_initializer=moving_variance_initializer,
            beta_regularizer=beta_regularizer,
            beta_constraint=beta_constraint,
            gamma1_constraint=gamma1_constraint,
            gamma2_constraint=gamma2_constraint,
